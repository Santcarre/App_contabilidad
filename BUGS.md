...
- [x] Móvil: diálogos (Nueva recurrencia, Nuevo presupuesto, etc.) sin límite de altura se salían de la pantalla sin poder hacer scroll. Fix: DialogContent con max-h-[90dvh] overflow-y-auto + SelectContent con max-h limitado por el viewport disponible (var de Radix) (15/08)
