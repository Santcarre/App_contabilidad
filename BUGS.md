...
- [x] Dashboard/reportes no reflejaban el cambio de moneda base: React Query sirve caché de 5 min (staleTime + refetchOnWindowFocus: false) y el key de reportes/presupuestos no incluye la base ni se invalidaba al guardar configuración. Fix: useUpdateConfig ahora invalida reports/budgets/transactions/rates al guardar, y useUpdateRatesNow también invalida reports/budgets (las conversiones dependen de las tasas) (15/08)
